...
export default function Coursework() {
  const courses_finished = [
    ...
    { name: "MATH-103", description: "Intro to Java Programming" },
  ...
  return (
   <section className="p-5 flex flex-col items-center" id="course">
      <h2 className="rounded-lg text-2xl font-bold mb-4 text-white bg-black bg-opacity-60 p-2">Finished Courses</h2>
      <div className="grid grid-cols-3 gap-4 p-4" id="skills">
